...
It's also possible that no integer solution exists for the system, in which cases we can't sadly obtain the price (imagine pressing the buttons exactly 42.63467 times 🤪).
