...
image: 'https://res.cloudinary.com/dwrurydlt/image/upload/v1716146701/Blog/download_t72rg3.jpg'
---
...
* [Fully remote, except when we need you](#-fully-remote-except-when-we-need-you)
* [1-year contract that we won't let you recede from](#-1-year-contract-that-we-wont-let-you-recede-from)
* [19 YoE but no degree? Still not a Senior](#-19-YoE-but-no-degree-still-not-a-Senior)
* [Not enough experience? Just lie on your CV!](#-not-enough-experience-just-lie-on-your-cv)
* [Don't want to lie? Let me amend your CV for you](#-dont-want-to-lie-let-me-amend-your-cv-for-you)
* [Still refuse to lie? Then you're a bit stupid, because everybody lies on their CV and employers don't notice anyway](#still-refuse-to-lie)
* [You should stop whatever you're doing coz the interview is more important](#you-should-stop-whatever-youre-doing)
* [Actually, we want you in the office because we don't trust you](#-actually-we-want-you-in-the-office-because-we-dont-trust-you)
* [We'll want an answer to a question we didn't ask](#-well-want-an-answer-to-a-question-we-didnt-ask)
* [You got requirements and expectations for the job? We basically don't care](#you-got-requirements-and-expectations)
* [We seek candidates with certain characteristics, but we tell the recruiter we want something different because… reasons](#we-seek-candidates)
* [We promise feedback and we forget to deliver](#-we-promise-feedback-and-we-forget-to-deliver)
* [Bonus track: the Salary Calculator](#-bonus-track-the-salary-calculator)
...
<img src="https://res.cloudinary.com/dwrurydlt/image/upload/v1716135887/Blog/cv_yoe_ef2kc9.png" alt="Extract from my CV" width="75%" />
...
<h3 id="still-refuse-to-lie">🚩 Still refuse to lie? Then you're a bit stupid, because everybody lies on their CV and employers don't notice anyway</h3>
...
<h3 id="you-should-stop-whatever-youre-doing">🚩 You should stop whatever you're doing coz the interview is more important</h3>
...
<h3 id="you-got-requirements-and-expectations">🚩 You got requirements and expectations for the job? We basically don't care.</h3>
...
<h3 id="we-seek-candidates">🚩 We seek candidates with certain characteristics, but we tell the recruiter we want something different because… reasons. <br />(Or maybe we don't know what we want in the first place)</h3>
