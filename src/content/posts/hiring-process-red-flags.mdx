...
### 🚩 We seek candidates with certain characteristics, but we tell the recruiter we want something different because… reasons. <br />(Or maybe we don't know what we want in the first place) {#we-seek-candidates}
