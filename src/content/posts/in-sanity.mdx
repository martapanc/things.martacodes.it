...
title: (In)Sanity
description: >-
  A hands-on comparison of two well-known CMSs, Sanity and Strapi - and why I
  picked Strapi in the end
slug: in-sanity
...
image: 'https://cdn.buttercms.com/CmuckI62SNuWh7d1aUmB'
---

### Cons vs Strapi

* Weird block / rich text format that requires PortableText, additionally little to no Markdown support
* Groq, no GraphQL
