...
```
function moveAllRobots(robots: Robot[], hiX?: number, hiY?: number, seconds = 100) {
...
function calcSafetyFactor(robots: Robot[], hiX?: number, hiY?: number) {
    ...
    return Object.values(quadrantCounts).reduce((product, count) => product * count, 1);
}
```
...
![Day 14 Part 2](https://res.cloudinary.com/dwrurydlt/image/upload/v1735574038/Blog/2024-day-14-part-2_xpzmlr.webp)
