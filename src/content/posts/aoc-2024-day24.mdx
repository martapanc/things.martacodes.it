...
![fullAdder.png](../../../../../Downloads/fullAdder.png)
...
![Screenshot 2024-12-30 at 15.51.41.png](../../../../../Screenshots/Screenshot 2024-12-30 at 15.51.41.png)

... and a number of _incorrect_ ones, like this with `z39` being the result of an `AND` instead of a `XOR` 🤔

![Screenshot 2024-12-30 at 15.53.47.png](../../../../../Screenshots/Screenshot 2024-12-30 at 15.53.47.png)

I mean, it's fairly easy to tell there's something wrong when spotting a circuit like this (notice `z05` and `frn`):

![Screenshot 2024-12-30 at 16.06.49.png](../../../../../Screenshots/Screenshot 2024-12-30 at 16.06.49.png)
