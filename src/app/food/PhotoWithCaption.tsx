...
const PhotoWithCaption = ({ photo }: PhotoWithCaptionProps) => {
    return (
        <div className="group relative">
            ...
            <div className="absolute bottom-3 flex h-fit min-h-12 w-full items-center
                justify-center bg-zinc-900/75 px-4 py-1 text-center font-handwritten-2
                text-lg text-white opacity-0 transition-opacity duration-200
