...
![fullAdder.png](https://res.cloudinary.com/dwrurydlt/image/upload/v1735580292/Blog/2024-day-24/fullAdder_dpqbp8.webp)
...
![Correct adder](https://res.cloudinary.com/dwrurydlt/image/upload/v1735580290/Blog/2024-day-24/Screenshot_2024-12-30_at_15.51.41_p8cdsh.webp)

... and a number of _incorrect_ ones, like this with `z39` being the result of an `AND` instead of a `XOR` 🤔

![Incorrect adder 1](https://res.cloudinary.com/dwrurydlt/image/upload/v1735580288/Blog/2024-day-24/Screenshot_2024-12-30_at_15.53.47_uqzpvl.webp)

I mean, it's fairly easy to tell there's something wrong when spotting a circuit like this (notice `z05` and `frn`):

![Incorrect adder 2](https://res.cloudinary.com/dwrurydlt/image/upload/v1735580288/Blog/2024-day-24/Screenshot_2024-12-30_at_16.06.49_kpnhyx.webp)
