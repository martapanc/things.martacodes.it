...
- [Actually, we want you in the office because we don't trust you](#-wctually-we-want-you-in-the-office-because-we-dont-trust-you)
- [We'll want an answer to a question we didn't ask](#-well-want-an-answer-to-a-question-we-didnt-ask)
- [You got requirements and expectations for the job? We basically don't care](#-wou-got-requirements-and-expectations-for-the-job-We-basically-dont-care)
...
> Up to €380/day for a senior full-stack dev, provided they have either:• a MSc and 10/12 YoE• a BSc and 15 YoE• 20 YoE
...
### 🚩 We seek candidates with certain characteristics, but we tell the recruiter we want something different because… reasons. (Or maybe we don't know what we want in the first place) \{#we-seek-candidates\}
